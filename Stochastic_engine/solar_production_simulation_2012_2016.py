...
#    plt.plot(predicted,alpha=0.5)
    ...
    for i in range(0,sim_years):
        for j in range(0,12):
            ...
            solar_sim[i*8760+j*30*24:i*8760+j*30*24 + 30*24] = c_cap*solar_sim[i*8760+j*30*24:i*8760+j*30*24 + 30*24]
                  
            if j > 10:
                solar_sim[i*8760 + 8758:i*8760+8760] = c_cap*solar_sim[i*8760 + 8758:i*8760+8760]
